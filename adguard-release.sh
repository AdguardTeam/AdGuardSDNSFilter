...
gh pr create --base mpenachayan:master --fill --assignee @me --title "[$CURRENT_DATE] Release preparation for day $(date +%d/%m/%Y)" --body "Release of Adguard Custom Filters generated for AdGuard Home to close issue #$ISSUE_NUMBER"
